/* Autora: Profª Cláudia Werlich - clawer@gmail.com
Pode ser utilizado: mas insira os créditos para a Autora */
  ...
  for(i=0;i<TAM;i++)
   {
        ...
        cout<<"Digite o Nome do Aluno:  "; //leitura para o char nome[45]
        fflush(stdin);
        gets(Aluno[i].nome);
        fflush(stdin);
         ...
         if (strcmpi(Aluno[i].nome,novo_nome)==0)
            {
                 ...
                 fflush(stdin);
				 puts(Aluno[i].nome);
                 cout<<"Sobrenome do Aluno: ";
				 fflush(stdin);
				 puts(Aluno[i].sobrenome);
         ...
         if (strcmpi(Aluno[i].nome,novo_curso)==0) //Achou o registro
            {
				 ...
				 fflush(stdin);
				 puts(Aluno[i].sobrenome);
                 cout<<"\n Salario do Aluno:  "<<Aluno[i].salario;
                 cout<<"\n Curso Escolhido:  ";
				 fflush(stdin);
				 puts(Aluno[i].curso);  
                 cout<<"\n Notas Cadastradas: ";
         ...
         if (strcmpi(Aluno[i].nome,novo_sobrenome)==0)
            {
				 ...
				 fflush(stdin);
				 puts(Aluno[i].sobrenome);
                 cout<<"\n Salário do Aluno:  "<<Aluno[i].salario;
                 cout<<"\n Curso Escolhido:  ";
				 fflush(stdin);
				 puts(Aluno[i].curso);  
                 cout<<"\n Notas Cadastradas: ";
               ...
               cout<<" \n\n CURSO ESCOLHIDO: "<<Aluno[i].curso;  //ARRUMAR PARA TEM CERTEZA? QUER TROCAR?
              do{
                cout<<"\n Quantas notas esse aluno possui? Limite deve ser até 10:  ";                     
                cin>>qtde_notas;
                if ((qtde_notas<0)||(qtde_notas>10))
                  cout<<"\n\a\n\a ERRO LIMITE É DE 10 NOTAS:  ";
              }while ((qtde_notas<0)||(qtde_notas>10));
            ...
            cin>>Aluno[i].casado; // arrumar com o do
             do{
                 ...
                 { 
                   ...
                   cout<<"\n\n ERRO - DATA INVÁLIDA - INFORME A DATA NOVAMENTE ";
               }while(data_ok==1); 
      }//if
       }//if
       } //if
