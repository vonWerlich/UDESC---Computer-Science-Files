...
--para desfazer a exceção da transação, executar o seguinte comando:
--Rollback
...
begin transaction;
INSERT INTO setor values (5, 'Mecânica Premium');
...
begin transaction;
update mecanico m SET nome=('Mec. '||m.nome);
update cliente c SET nome=('Cli. '||c.nome);
end transaction;

-- 7) Atualize o cods dos mecânicos alocados no setor 3 para 4 e exclua o setor de cods 3.
begin transaction;
update mecanico m SET cods=4 WHERE cods=3;
