...
public class Principal extends JFrame {
	...
	private final JLabel lblNewLabel_9_1 = new JLabel("Id");
		...
		botaoAluno_2.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					int resposta = JOptionPane.showConfirmDialog(null, "Certeza que quer remover a pessoa de id "+ temp +"?");
		...
		botaoremoveEst.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					int resposta = JOptionPane.showConfirmDialog(null, "Certeza que quer remover o estudante de id "+ temp +"?");
		...
		botaoremoveProf.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					int resposta = JOptionPane.showConfirmDialog(null, "Certeza que quer remover o professor de id "+ temp +"?");
		...
		botaoremovedep.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					int resposta = JOptionPane.showConfirmDialog(null, "Certeza que quer remover o departamento de numdep "+ temp +"?");
		...
		botaoremoveProjeto.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					int resposta = JOptionPane.showConfirmDialog(null, "Certeza que quer remover o projeto de númerp "+ temp +"?");
		...
		botaoremoveProjProf.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					int resposta = JOptionPane.showConfirmDialog(null, "Certeza que quer remover o professor "+ temp1 +" do projeto "+temp2+"?");
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					textField_34.setText("");
						...
						JOptionPane.showMessageDialog(null, "Esse professor não pode ter carga horária maior que 100%!");
					}
				} catch (Exception e) {
		                e.getMessage();
				}
