...
entrada_dir = "htmls_tomate"            # Pasta com os HTMLs principais
saida_dir = "textos_tomate"             # Pasta para salvar os textos finais
galeria_dir = "htmls_galeria_tomate"    # Pasta onde estão os HTMLs de galeria renderizados
